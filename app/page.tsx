...
//     () => uniqueResults.filter(x => matchesRecipeSearch(x.recipe as Recipe, query)),
//     [uniqueResults, query]
//   )
...
//         ingredients: (data.ingredients || []).map((i: { name?: string; quantity?: string }) => ({
...
//   return (
//     <div 
//       className="min-h-screen p-6 md:p-10 space-y-10"
...
export default function Page() {
  ...
  if (!user) {
    return <LoginForm onLogin={(email) => setUser(email)} />;
  }
